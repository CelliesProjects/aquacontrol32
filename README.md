...
<br><br>Checkout the BOM on the [Aquacontrol hardware GitHub repo](aquacontrol-hardware/BOM.md) to see how to connect the hardware.
...
- Check the [Aquacontrol hardware GitHub repo](aquacontrol-hardware/BOM.md).
